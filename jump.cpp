 ...
 * Jump::set_node                                                *
\**************************************************************************/
void Jump::set_node(irr::scene::IAnimatedMeshSceneNode *n)
{
  node = n;
}
 ...
 * Jump::set_camera                                                *
\**************************************************************************/
void Jump::set_camera(is::ICameraSceneNode *c)
{
  camera = c;
}
...
/**************************************************************************\
 * Jump::set_lateral_speed                                                *
\**************************************************************************/
void Jump::set_lateral_speed(float ls)
{
  lateral_speed = ls;
}
...
/**************************************************************************\
 * Jump::set_double_jumping                                                *
\**************************************************************************/
void Jump::set_double_jumping(bool dj)
{
  isDoubleJumping = dj;
}
