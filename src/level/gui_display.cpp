 ...
 * Gui_display::set_gui                                           *
\**************************************************************************/
void Gui_display::set_gui(irr::gui::IGUIEnvironment *g)
{
	gui = g;
}

/**************************************************************************\
 * Gui_display::set_driver                                           *
\**************************************************************************/
void Gui_display::set_driver(irr::video::IVideoDriver *d)
{
	driver = d;
}

/**************************************************************************\
 * Gui_display::set_player_state                                           *
\**************************************************************************/
void Gui_display::set_player_state(Player_state *p_s)
{
	player_state = p_s;
}
